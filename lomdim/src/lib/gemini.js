...
function buildParts(payload) {
  ...
  if (task === 'renikud') {
    ...
    parts.push({ text:
      ...
      ` אל תנקד/י אף מילה אחרת (לא צורות פועל אחרות, לא שמות עצם, כלום), ואל תשנה/י ניסוח, מילים, או סדר האפשרויות. אם אין בשאלה בניין או שם מספר — החזר/י אותה בדיוק כפי שהיא. ` +
